...
func (s *V4Seeder) seedTourIterations() error {
	...
	op := []seeder.SeedOperation{{
		...
		Query: `INSERT INTO tour_iterations (tour_id, start_date, end_date) VALUES ($1, $2, $3)`,
		Builder: func(f *gofakeit.Faker) []interface{} {
			t := models.GetRandomFromSlice(tours)
			return []interface{}{t.ID, f.Date(), f.Date()}
		},
	}}
...
func (s *V4Seeder) seedTourRoutes() error {
	...
	op := []seeder.SeedOperation{{
		...
		Query: `INSERT INTO tour_routes (tour_id) VALUES ($1)`,
		Builder: func(f *gofakeit.Faker) []interface{} {
			t := models.GetRandomFromSlice(tours)
...
func (s *V4Seeder) seedRoutePoints() error {
	...
	if err := s.TryGetAllEntities("tour_routes", &routes, "SELECT id FROM tour_routes"); err != nil {
		return err
	}
	...
	op := []seeder.SeedOperation{{
		...
		Query: `INSERT INTO route_points (route_id, city_id, name, address, duration_time, in_route_order_position) 
				VALUES ($1, $2, $3, $4, $5, $6)`,
		Builder: func(f *gofakeit.Faker) []interface{} {
			...
			return []interface{}{
				...
				f.City(),
				f.Address().Address,
				fmt.Sprintf("%dh %dm", f.Number(1, 5), f.Number(0, 59)),
				f.Number(1, 10),
			}
		},
	}}
...
func (s *V4Seeder) seedTransportServices() error {
	op := []seeder.SeedOperation{{
		...
		Query: `INSERT INTO transport_services (company, model) VALUES ($1, $2)`,
		Builder: func(f *gofakeit.Faker) []interface{} {
			return []interface{}{f.Company(), f.CarModel()}
		},
	}}
	return s.BatchSeed(op)
}
...
func (s *V4Seeder) seedTransfers() error {
	...
	if err := s.TryGetAllEntities("transport_services", &transports, "SELECT id FROM transport_services"); err != nil {
		return err
	}
	if err := s.TryGetAllEntities("route_points", &points, "SELECT id FROM route_points"); err != nil {
		return err
	}
	op := []seeder.SeedOperation{{
		Name: "insert transfers",
		Query: `INSERT INTO transfers (tour_id, transport_id, departure_point, arrival_point, departure_time) 
				VALUES ($1, $2, $3, $4, $5)`,
		Builder: func(f *gofakeit.Faker) []interface{} {
			return []interface{}{
...
func (s *V4Seeder) seedOrganizers() error {
	op := []seeder.SeedOperation{{
		...
		Query: `INSERT INTO organizers (name, phone, email) VALUES ($1, $2, $3)`,
		Builder: func(f *gofakeit.Faker) []interface{} {
			return []interface{}{f.Name(), f.Phone(), f.Email()}
		},
	}}
	return s.BatchSeed(op)
}
...
func (s *V4Seeder) seedExcursions() error {
	...
	if err := s.TryGetAllEntities("organizers", &organizers, "SELECT id FROM organizers"); err != nil {
		return err
	}
	if err := s.TryGetAllEntities("route_points", &points, "SELECT id FROM route_points"); err != nil {
		return err
	...
	op := []seeder.SeedOperation{{
		...
		Query: `INSERT INTO excursions (tour_id, organizer_id, name, meeting_location, meeting_time) 
				VALUES ($1, $2, $3, $4, $5)`,
		Builder: func(f *gofakeit.Faker) []interface{} {
			return []interface{}{
				models.GetRandomFromSlice(tours).ID,
...
func (s *V4Seeder) seedInsuranceCompanies() error {
	op := []seeder.SeedOperation{{
		...
		Query: `INSERT INTO insurance_companies (name, phone, email) 
				VALUES ($1, $2, $3)`,
		Builder: func(f *gofakeit.Faker) []interface{} {
			return []interface{}{f.Company(), f.Phone(), f.Email()}
		},
	}}
	return s.BatchSeed(op)
}
...
func (s *V4Seeder) seedInsurances() error {
	...
	var tours []models.Tour
	if err := s.TryGetAllEntities("insurance_companies", &companies, "SELECT id FROM insurance_companies"); err != nil {
		return err
	}
	if err := s.TryGetAllEntities("tours", &tours, "SELECT id FROM tours"); err != nil {
		return err
	...
	op := []seeder.SeedOperation{{
		...
		Query: `INSERT INTO insurances (tour_id, insurance_company_id, coverage_type) 
				VALUES ($1, $2, $3)`,
		Builder: func(f *gofakeit.Faker) []interface{} {
			return []interface{}{
				models.GetRandomFromSlice(tours).ID,
